...
const liuyuxing = [
    '滁河', '望虞河', '泰州引江河', '秦淮河', '水阳江', '太浦河', '淮河下游入江水道', '新孟河', '京杭运河白马湖-高宝湖长江区段'
]
const quyuxing = [
...
const shuizha = [
    '秦淮新河节制闸', '三汊河河口闸', '朱家山河闸', '划子口节制闸', '瓜洲节制闸', '泰州引江河枢纽—高港节制闸', '夏仕港节制闸', '焦土港闸', "望虞河常熟水利枢纽-水闸工程",
    '岳子河河闸', '中坝闸', '七摆渡闸站', '引航道枢纽工程-水闸工程', '京口闸', '三茅镇沙家港闸', '口岸闸', '过船节制闸',
    '天星港闸', '太字港节制闸', '南通节制闸', '营船港闸', '白茆闸', '浏河节制闸'
]
const bengzhan = [
    '望虞河常熟水利枢纽泵站工程', '秦淮新河闸站一泵站工程', '武定门闸站—泵站工程', '澡港河水利枢纽-泵站工程', '魏村水利枢纽-泵站工程', '谏壁抽水站',
    '高港泵站', '九圩港提水泵站', '杨家沟站', '大年站', '十二圩翻水站', '大年站', '引航道枢纽工程-泵站工程',
    '东风泵站', '大港泵站', '上九圩泵站', '新夏港泵站', '焦港泵站', '三干河泵站', '七浦塘江边枢纽泵站', '新沟泵站',
]
