...
export default class SteadyFlowLayer {
    ...
    async init() {
        ...
        this.trajectoryPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Background Trajectory)', '/scratchSomething/terrain_flow/shader/trajectory.wgsl') },
        ...
        this.segmentPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Segment)', '/scratchSomething/terrain_flow/shader/segment.wgsl') },
            colorTargetStates: [ { blend: scr.PremultipliedBlending } ],
        ...
        this.arrowPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Flow Show)', '/scratchSomething/terrain_flow/shader/arrow.wgsl') },
            primitive: { topology: 'triangle-strip' },
            colorTargetStates: [ { blend: scr.NormalBlending } ],
        })
