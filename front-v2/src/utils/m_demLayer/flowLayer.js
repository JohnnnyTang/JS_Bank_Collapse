...
const resourceUrl = [
    //  /scratchSomething/terrain_flow/json/stations_0.json
    '/scratchSomething/terrain_flow/json/stations_0.json',
    '/scratchSomething/terrain_flow/json/stations_1.json',
    '/scratchSomething/terrain_flow/json/stations_2.json',
    '/scratchSomething/terrain_flow/json/stations_3.json',
    '/scratchSomething/terrain_flow/json/stations_4.json',
    '/scratchSomething/terrain_flow/json/stations_5.json',
    '/scratchSomething/terrain_flow/json/stations_6.json',
    '/scratchSomething/terrain_flow/json/stations_7.json',
    '/scratchSomething/terrain_flow/json/stations_8.json',
    '/scratchSomething/terrain_flow/json/stations_9.json',
    '/scratchSomething/terrain_flow/json/stations_10.json',
    '/scratchSomething/terrain_flow/json/stations_11.json',
    '/scratchSomething/terrain_flow/json/stations_12.json',
    '/scratchSomething/terrain_flow/json/stations_13.json',
    '/scratchSomething/terrain_flow/json/stations_14.json',
    '/scratchSomething/terrain_flow/json/stations_15.json',
    '/scratchSomething/terrain_flow/json/stations_16.json',
    '/scratchSomething/terrain_flow/json/stations_17.json',
    '/scratchSomething/terrain_flow/json/stations_18.json',
    '/scratchSomething/terrain_flow/json/stations_19.json',
    '/scratchSomething/terrain_flow/json/stations_20.json',
    '/scratchSomething/terrain_flow/json/stations_21.json',
    '/scratchSomething/terrain_flow/json/stations_22.json',
    '/scratchSomething/terrain_flow/json/stations_23.json',
    '/scratchSomething/terrain_flow/json/stations_24.json',
    '/scratchSomething/terrain_flow/json/stations_25.json',
    '/scratchSomething/terrain_flow/json/stations_26.json',
]
...
export default class FlowLayer {
    ...
    constructor() {
        ...
        this.randomFillData = new Float32Array(this.maxParticleNum * 4).map((_, index) => {
    ...
    async onAdd(map, gl) {
        ...
        this.voronoiPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Flow Voronoi)', '/scratchSomething/terrain_flow/shader/flowVoronoi.wgsl') },
        })
        ...
        await this.addVoronoiBindingSync('/scratchSomething/terrain_flow/json/stations_0.json'); this.swapVoronoiBinding()
        await this.addVoronoiBindingSync('/scratchSomething/terrain_flow/json/stations_1.json'); this.swapVoronoiBinding()
        ...
        this.simulationPipeline = scr.computePipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Particle Simulation)', '/scratchSomething/terrain_flow/shader/simulation.compute.wgsl') },
        ...
        this.trajectoryPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Background Swap)', '/scratchSomething/terrain_flow/shader/swap.wgsl') },
        ...
        this.particlePipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Particles)', '/scratchSomething/terrain_flow/shader/particles.wgsl') },
            primitive: { topology: 'triangle-strip' },
        })
        this.swapPasses = [
            scr.renderPass({
        ...
        this.layerPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Flow Layer Rendering)', '/scratchSomething/terrain_flow/shader/flowLayer.wgsl') },
            primitive: { topology: 'triangle-strip' },
        ...
        this.showPipeline = scr.renderPipeline({
            ...
            shader: { module: scr.shaderLoader.load('Shader (Flow Show)', '/scratchSomething/terrain_flow/shader/flowShow.wgsl') },
            primitive: { topology: 'triangle-strip' },
            colorTargetStates: [ { blend: scr.NormalBlending } ],
        })
