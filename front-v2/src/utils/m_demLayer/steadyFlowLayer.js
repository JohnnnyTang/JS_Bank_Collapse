...
const resourceUrl = [
    '/scratchSomething/terrain_flow/json/uv_0.bin',
    '/scratchSomething/terrain_flow/json/uv_1.bin',
    '/scratchSomething/terrain_flow/json/uv_2.bin',
    '/scratchSomething/terrain_flow/json/uv_3.bin',
    '/scratchSomething/terrain_flow/json/uv_4.bin',
    '/scratchSomething/terrain_flow/json/uv_5.bin',
    '/scratchSomething/terrain_flow/json/uv_6.bin',
    '/scratchSomething/terrain_flow/json/uv_7.bin',
    '/scratchSomething/terrain_flow/json/uv_8.bin',
    '/scratchSomething/terrain_flow/json/uv_9.bin',
    '/scratchSomething/terrain_flow/json/uv_10.bin',
    '/scratchSomething/terrain_flow/json/uv_11.bin',
    '/scratchSomething/terrain_flow/json/uv_12.bin',
    '/scratchSomething/terrain_flow/json/uv_13.bin',
    '/scratchSomething/terrain_flow/json/uv_14.bin',
    '/scratchSomething/terrain_flow/json/uv_15.bin',
    '/scratchSomething/terrain_flow/json/uv_16.bin',
    '/scratchSomething/terrain_flow/json/uv_17.bin',
    '/scratchSomething/terrain_flow/json/uv_18.bin',
    '/scratchSomething/terrain_flow/json/uv_19.bin',
    '/scratchSomething/terrain_flow/json/uv_20.bin',
    '/scratchSomething/terrain_flow/json/uv_21.bin',
    '/scratchSomething/terrain_flow/json/uv_22.bin',
    '/scratchSomething/terrain_flow/json/uv_23.bin',
    '/scratchSomething/terrain_flow/json/uv_24.bin',
    '/scratchSomething/terrain_flow/json/uv_25.bin',
]
...
export default class SteadyFlowLayer {
    ...
    async onAdd(map, gl) {
        ...
        await this.getVoronoi('/scratchSomething/terrain_flow/json/station.bin')
        await this.addVoronoiBindingSync(
            '/scratchSomething/terrain_flow/json/uv_0.bin',
        )
        ...
        this.voronoiPipeline = scr.renderPipeline({
            ...
            shader: {
                module: scr.shaderLoader.load(
                    'Shader (Flow Voronoi)',
                    '/scratchSomething/terrain_flow/shader/flowVoronoi.wgsl',
                ),
            },
        })
        ...
        this.simulationPipeline = scr.computePipeline({
            ...
            shader: {
                module: scr.shaderLoader.load(
                    ...
                    '/scratchSomething/terrain_flow/shader/simulation.compute.wgsl',
                ),
            },
        ...
        this.trajectoryPipeline = scr.renderPipeline({
            ...
            shader: {
                module: scr.shaderLoader.load(
                    ...
                    '/scratchSomething/terrain_flow/shader/swap.wgsl',
                ),
            },
        ...
        this.particlePipeline = scr.renderPipeline({
            ...
            shader: {
                module: scr.shaderLoader.load(
                    'Shader (Particles)',
                    '/scratchSomething/terrain_flow/shader/particles.wgsl',
                ),
            },
        ...
        this.swapPasses = [
            scr
                ...
                /* Pass 3.1 */ .add(
                    this.trajectoryPipeline,
                    this.trajectoryBindings[0],
                )
                /* Pass 3.2 */ .add(
                    this.particlePipeline,
                    this.particleBinding,
                ),
        ...
        this.layerPipeline = scr.renderPipeline({
            ...
            shader: {
                module: scr.shaderLoader.load(
                    ...
                    '/scratchSomething/terrain_flow/shader/flowLayer.wgsl',
                ),
            },
            primitive: { topology: 'triangle-strip' },
        ...
        this.showPipeline = scr.renderPipeline({
            ...
            shader: {
                module: scr.shaderLoader.load(
                    'Shader (Flow Show)',
                    '/scratchSomething/terrain_flow/shader/flowShow.wgsl',
                ),
            },
            primitive: { topology: 'triangle-strip' },
            colorTargetStates: [{ blend: scr.NormalBlending }],
        ...
        this.arrowPipeline = scr.renderPipeline({
            ...
            shader: {
                module: scr.shaderLoader.load(
                    'Shader (Flow Show)',
                    '/scratchSomething/terrain_flow/shader/arrow.wgsl',
                ),
            },
            primitive: { topology: 'triangle-strip' },
            colorTargetStates: [{ blend: scr.NormalBlending }],
        ...
        this.showArrow &&
            this.map
                .add2RenderPass(this.arrowPipeline, this.particleBinding)
    ...
    makeVisibility(visibility) {
        ...
        //     // Binding
        //     this.showBinding.executable = false
        //     this.voronoiBinding.executable = false
        //     this.particleBinding.executable = false
        //     // this.voronoiToBinding.executable = false
        //     this.simulationBinding.executable = false
        //     // this.layerBindings = undefined
        //     // this.trajectoryBindings = undefined
        //     this.layerBindings.forEach((item) => {
        //         item.executable = false
        //     })
        //     this.trajectoryBindings.forEach((item) => {
        //         item.executable = false
        //     })

        //     // Pipeline
        //     this.showPipeline.executable = false
        //     this.layerPipeline.executable = false
        //     this.voronoiPipeline.executable = false
        //     this.particlePipeline.executable = false
        //     this.trajectoryPipeline.executable = false
        //     this.simulationPipeline.executable = false
        ...
        //     // Binding
        //     this.showBinding.executable = true
        //     this.voronoiBinding.executable = true
        //     this.particleBinding.executable = true
        //     // this.voronoiToBinding.executable = true
        //     this.simulationBinding.executable = true
        //     // this.layerBindings = undefined
        //     // this.trajectoryBindings = undefined
        //     this.layerBindings.forEach((item) => {
        ...
        //     // Pipeline
        //     this.showPipeline.executable = true
        //     this.layerPipeline.executable = true
        //     this.voronoiPipeline.executable = true
        //     this.particlePipeline.executable = true
        //     this.trajectoryPipeline.executable = true
        //     this.simulationPipeline.executable = true
    ...
    updateMaxSpeed(maxSpeed) {
        this.maxSpeed.n =
            maxSpeed > this.maxSpeed.n ? maxSpeed : this.maxSpeed.n
    }
