...
export default class FlowFieldLayer {
    ...
    set progressRate(value) {
        ...
        if (currentPhase != lastPhase) {
            ...
            this.UpdateTextureByImage(gl, this.seedingTextureArr[index], gl.RGBA, gl.NEAREST, this.parser.seedingTexSize[0], this.parser.seedingTexSize[1], this.parser.seedingResourceArr[nextPhase], 'UNSIGHNED_BYTE');
        }
    }
    get progressRate() {
