        ...
        <div class="model-content-container">
            ...
            <div class="model-item-container">
                <div class="switch-icon">
                    <img src="/icons/switch.png" alt="switch" @click="switchContent">
                </div>
                    ...
                    <div v-if="firstPage == true" class="calculate-data-container">
                        <div class="calculate-data-wrapper">
                            <div class="calculate-data-title">
                                <div v-if="ifShowData == false" class="data-title-icon">
                                    <img src="/data.png" alt="data">
                                </div>
                                <div v-if="ifShowData == true" class="data-shower-icon">
                                    <img src="/dataTable.png" alt="data">
                                </div>
                                <div class="data-title-text">模型计算数据</div>
                            </div>
                            <div v-if="ifShowData == false" class="calculate-data-content">
                                <DataCardVue @showData="showData" v-for="(item, index) in ModelDataList"
                                    :title="item.title" :desc="item.desc" :iconSrc="item.iconSrc" :data="item.data" />
                            </div>
                            <div class="data-shower-content" v-if="ifShowData == true">
                                <DataShowTableVue :tableData="tableData" />
                                <div class="switch-icon-data" @click="ifShowData = false">
                    ...
                    <div class="calculate-result-container">
                        <div class="calculate-result-wrapper">
                            ...
                            <div class="calculate-result-content">
                                <ResultCardVue v-for="(item, index) in ModelResultList" :title="item.title"
                                    :time="item.time" :iconSrc="item.iconSrc" />
                            </div>
                        </div>
                    </div>
                </div>
