...
export const getDeviceIdPlaceMap = () => {
    return {
        '': '暂无',
...
export const getButtonInfoList = () => {
    return [
        {
            index: 0,
            name: '南通段预案',
            url: import.meta.env.VITE_BASE + '/pdf/11.长江南通段民主沙撤离预案.pdf',
            pageNum: '29',
        },
        {
            index: 1,
            name: '靖江段预案',
            url: import.meta.env.VITE_BASE + '/pdf/30.靖江市民主沙行洪运用预案.pdf',
            pageNum: '41',
        },
        {
            index: 2,
            name: '重点防御预案',
            url: import.meta.env.VITE_BASE + '/pdf/75靖江市民主沙(右缘)险工段重点防御预案.pdf',
            pageNum: '63',
        },
    ]
}
...
export const getBankWarnDetail = () => {
    return [
        {
            风险点负责人: '高卫南',
            责任人联系方式: '15161059955',
...
/////////////////////////////////DeviceWarn/////////////////////////////////
export const getSectionClassColorMap = () => {
    return {
        警告: 'warning',
        预警: 'pre-warning',
        关注: 'attention',
...
export const getColorGradientMap = () => {
    return [
        ['#A7EBBC', '#12A734'],
        ['#00ACFF', '#0212a1'],
        ['#FFE56C', '#e48b18'],
...
export const getDeviceTypeNameMap = () => {
    return {
        位移测量站: 'gnss',
        测斜仪: 'inclinometer',
        孔隙水压力计: 'manometer',
...
export const getDeviceTypeErrorMap = () => {
    return {
        位移测量站: 5,
        测斜仪: 3,
        孔隙水压力计: 0.2,
...
export const getDeviceTypeTimeMap = () => {
    return {
        位移测量站: {
            timeUnit: 'day',
            timeCount: 60,
...
export const getFunctionIndexList = () => {
    return [
        0, 1, 2, 3, 8, 9, 10, 11
    ]
}
...
export const getStableStatusLineData = () => {
    return [
        [8, 6, 5, 5, 3, 0, 0, 0],
        [13, 13, 12, 10, 8, 6, 0, 0],
...
/////////////////////////////////WarnHistoryTable/////////////////////////////////
export const getWarnHistoryList = () => {
    return [
        {
            id: '暂无',
            warnTime: '暂无',
