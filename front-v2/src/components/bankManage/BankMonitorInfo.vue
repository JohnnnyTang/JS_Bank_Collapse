            ...
            <dv-border-box10>
                ...
                >
                    ...
                    <div class="video-key-val">
                        ...
                        <div class="video-val">{{ item.position }}</div>
                    </div>
...
const videoList = ref([
    { name: '测点1', position: '32.0432963, 120.5122242', videoUrl: '' },
    { name: '测点2', position: '32.0381061, 120.5263473', videoUrl: '' },
    { name: '测点3', position: '32.0316674, 120.5402574', videoUrl: '' },
])
