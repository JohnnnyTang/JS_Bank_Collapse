...
def main(jsonPath: str, date: str, condition: str):
    content: dict = {}
    # read json
    ...
    #     dataFolderPath, "raster", f"{date.replace('-','')}.tif"
    # )
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        ...
        # json 路径, 水文年, 水文状况
        [jsonPath, date, condition] = sys.argv[1:4]

        # test
        # D:\project\JS_Bank_Collapse\util\model\multi\test\result.json 2022-03-01 dry
        main(jsonPath, date, condition)
