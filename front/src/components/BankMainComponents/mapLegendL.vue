<template>
    <div class="legendCard">
        <div class="card2">
            <div id="title"><strong>图 例</strong></div>
            <hr />
            <div
...
.legendCard {
    width: 12vw;
    height: 26vh;
    // background-image: linear-gradient(163deg, #ffffff 0%, #302e38 50%);
    border-radius: 1vhpx;

    hr {
        border: 1px solid hsla(210, 70%, 40%, 0.8);
    }
