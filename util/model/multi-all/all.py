...
if __name__ == "__main__":
    if len(sys.argv) != 19:
        ...
        # 13413987.075052204 3769198.7731254 13413960.628213946 3768963.462827877 2023-09-01 2023-03-01 flood minzhusha 0.5 0.5 0.16 0.48 0.36 0.28 0.36 0.36 D:\project\JS_Bank_Collapse\util\model\multi-all\data D:\project\JS_Bank_Collapse\util\model\multi-all\test\result.json
        tag = section.main(
